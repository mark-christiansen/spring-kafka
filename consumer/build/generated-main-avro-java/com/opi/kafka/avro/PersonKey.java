...
public class PersonKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2008344845659302440L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonKey\",\"namespace\":\"com.opi.kafka.avro\",\"doc\":\"A person key\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Person full name\"}]}");
   ...
   */
  public PersonKey(java.lang.String name) {
    this.name = name;
  }
   ...
   */
  public static com.opi.kafka.avro.PersonKey.Builder newBuilder() {
    return new com.opi.kafka.avro.PersonKey.Builder();
  }
   ...
   * @return A new PersonKey RecordBuilder
   */
  public static com.opi.kafka.avro.PersonKey.Builder newBuilder(com.opi.kafka.avro.PersonKey.Builder other) {
    if (other == null) {
      return new com.opi.kafka.avro.PersonKey.Builder();
    } else {
      return new com.opi.kafka.avro.PersonKey.Builder(other);
    }
  }
   ...
   * @return A new PersonKey RecordBuilder
   */
  public static com.opi.kafka.avro.PersonKey.Builder newBuilder(com.opi.kafka.avro.PersonKey other) {
    if (other == null) {
      return new com.opi.kafka.avro.PersonKey.Builder();
    } else {
      return new com.opi.kafka.avro.PersonKey.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.opi.kafka.avro.PersonKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.opi.kafka.avro.PersonKey other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opi.kafka.avro.PersonKey.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opi.kafka.avro.PersonKey.Builder clearName() {
      name = null;
